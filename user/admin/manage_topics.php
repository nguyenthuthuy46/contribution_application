                                        ...
                                        while ($row = mysqli_fetch_array($res)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="" class="btn btn-info btn-get-info"
                                                       data-id="<?php echo $row["id"]; ?>" role="button"><i
                                                                class="mdi mdi-pencil-outline"
                                                                data-id="<?php echo $row["id"]; ?>"></i> </a>
                                                    <a href="" class="btn btn-danger btn-delete-topic" data-id="<?=$row['id']?>" role="button"><i
                                                                class="mdi mdi-delete"></i> </a>
                                                    <a href="" class="btn btn-primary btn-detail-info"
                                                       data-id="<?php echo $row["id"]; ?>" role="button"><i
                                                ...
                                                <div class="modal-body">
                                                    <form action="">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="inputTopicId">Topic ID</label>
                                                            <input type="text" class="form-control"
                                                                   id="topicCode" placeholder="Input Id"
                                                                   value="Topic_01">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="inputIdManager">Manager Topic</label>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" aria-label="With textarea"
                                                                      spellcheck="false" id="description"></textarea>
                                                            <grammarly-extension data-grammarly-shadow-root="true"
                                                                                 style="position: absolute; top: 0px; left: 0px; pointer-events: none; z-index: 3;"
                                                                                 class="cGcvT"></grammarly-extension>
                                                        </div>
